...
# 2009年有最高價格
# 1970年有最低價格
max(Cola$StockPrice,format(Cola_time,"%Y"))
min(Cola$StockPrice,format(Cola_time,"%Y"))
...
```{r}
# December
tapply(GE$StockPrice,format(GE_time,"%m"),mean)
tapply(Cola$StockPrice,format(Cola_time,"%m"),mean)
```
